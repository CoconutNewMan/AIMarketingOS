...
- Supabase anon key: `[REDACTED — stored in .env and Vercel env vars]`
- Supabase service role key: `[REDACTED — stored in Supabase Edge Function secrets only]`
- Claude API key: `[REDACTED — stored in Supabase Edge Function secrets only]`
